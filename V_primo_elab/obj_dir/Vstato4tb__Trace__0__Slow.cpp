...
VL_ATTR_COLD void Vstato4tb___024root__trace_init_sub__TOP__0(Vstato4tb___024root* vlSelf, VerilatedVcd* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstato4tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstato4tb___024root__trace_init_sub__TOP__0\n"); );
    // Init
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->pushPrefix("stato4tb", VerilatedTracePrefixType::SCOPE_MODULE);
...
VL_ATTR_COLD void Vstato4tb___024root__trace_init_top(Vstato4tb___024root* vlSelf, VerilatedVcd* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstato4tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstato4tb___024root__trace_init_top\n"); );
    // Body
    Vstato4tb___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vstato4tb___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vstato4tb___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vstato4tb___024root__trace_register(Vstato4tb___024root* vlSelf, VerilatedVcd* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstato4tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstato4tb___024root__trace_register\n"); );
    // Body
    tracep->addConstCb(&Vstato4tb___024root__trace_const_0, 0U, vlSelf);
    tracep->addFullCb(&Vstato4tb___024root__trace_full_0, 0U, vlSelf);
    tracep->addChgCb(&Vstato4tb___024root__trace_chg_0, 0U, vlSelf);
    tracep->addCleanupCb(&Vstato4tb___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vstato4tb___024root__trace_const_0_sub_0(Vstato4tb___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vstato4tb___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstato4tb___024root__trace_const_0\n"); );
    // Init
    Vstato4tb___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vstato4tb___024root*>(voidSelf);
    Vstato4tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vstato4tb___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vstato4tb___024root__trace_const_0_sub_0(Vstato4tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstato4tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstato4tb___024root__trace_const_0_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullCData(oldp+37,(vlSelf->stato4tb__DOT__dut__DOT__ad2),3);
    bufp->fullIData(oldp+38,(3U),32);
    bufp->fullIData(oldp+39,(1U),32);
    bufp->fullIData(oldp+40,(1U),32);
}

VL_ATTR_COLD void Vstato4tb___024root__trace_full_0_sub_0(Vstato4tb___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vstato4tb___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstato4tb___024root__trace_full_0\n"); );
    // Init
    Vstato4tb___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vstato4tb___024root*>(voidSelf);
    Vstato4tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vstato4tb___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vstato4tb___024root__trace_full_0_sub_0(Vstato4tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstato4tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstato4tb___024root__trace_full_0_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullCData(oldp+1,(vlSelf->stato4tb__DOT__PRICE_P1),3);
    bufp->fullCData(oldp+2,(vlSelf->stato4tb__DOT__PRICE_P2),3);
    bufp->fullCData(oldp+3,(vlSelf->stato4tb__DOT__PRICE_P3),3);
    bufp->fullCData(oldp+4,(vlSelf->stato4tb__DOT__PRICE_P4),3);
    bufp->fullCData(oldp+5,(vlSelf->stato4tb__DOT__CREDITO),3);
    bufp->fullCData(oldp+6,(vlSelf->stato4tb__DOT__Sel),2);
    bufp->fullBit(oldp+7,(vlSelf->stato4tb__DOT__INTERNO));
    bufp->fullCData(oldp+8,(vlSelf->stato4tb__DOT__dut__DOT__dd1),3);
    bufp->fullCData(oldp+9,(vlSelf->stato4tb__DOT__dut__DOT__dd2),3);
    bufp->fullBit(oldp+10,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__nn1));
    bufp->fullBit(oldp+11,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__nn2));
    bufp->fullBit(oldp+12,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__nn3));
    bufp->fullBit(oldp+13,((1U & ((IData)(vlSelf->stato4tb__DOT__dut__DOT__dd2) 
                                  >> 2U))));
    bufp->fullBit(oldp+14,((1U & ((IData)(vlSelf->stato4tb__DOT__dut__DOT__dd2) 
                                  >> 1U))));
    bufp->fullBit(oldp+15,((1U & (IData)(vlSelf->stato4tb__DOT__dut__DOT__dd2))));
    bufp->fullCData(oldp+16,(vlSelf->stato4tb__DOT__Resto),3);
    bufp->fullCData(oldp+17,((7U & ((IData)(1U) + (~ (IData)(vlSelf->stato4tb__DOT__dut__DOT__Maggiore))))),3);
    ...
    bufp->fullCData(oldp+19,(vlSelf->stato4tb__DOT__dut__DOT__Maggiore),3);
    bufp->fullCData(oldp+20,(vlSelf->stato4tb__DOT__dut__DOT__Minore),3);
    bufp->fullBit(oldp+21,((((IData)(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__aa1) 
    ...
    bufp->fullBit(oldp+22,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__cc2));
    bufp->fullBit(oldp+23,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__cc3));
    bufp->fullBit(oldp+24,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__xx1));
    bufp->fullBit(oldp+25,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__aa1));
    bufp->fullBit(oldp+26,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__aa2));
    bufp->fullBit(oldp+27,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__aa3));
    bufp->fullBit(oldp+28,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__aa4));
    bufp->fullBit(oldp+29,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__aa5));
    bufp->fullBit(oldp+30,(((IData)(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__aa1) 
                            | (IData)(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__aa4))));
    bufp->fullBit(oldp+31,(vlSelf->stato4tb__DOT__dut__DOT__Mm1__DOT__Comp1__DOT__aa6));
    bufp->fullCData(oldp+32,(vlSelf->stato4tb__DOT__dut__DOT__mm1),3);
    bufp->fullBit(oldp+33,((1U & ((IData)(vlSelf->stato4tb__DOT__dut__DOT__mm1) 
                                  >> 2U))));
    bufp->fullBit(oldp+34,((1U & ((IData)(vlSelf->stato4tb__DOT__dut__DOT__mm1) 
                                  >> 1U))));
    bufp->fullBit(oldp+35,((1U & (IData)(vlSelf->stato4tb__DOT__dut__DOT__mm1))));
    bufp->fullBit(oldp+36,((1U & (~ (((IData)(vlSelf->stato4tb__DOT__dut__DOT__dd2) 
