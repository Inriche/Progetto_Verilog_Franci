...
#include "Vtb_gen_int___024unit.h"

VL_ATTR_COLD void Vtb_gen_int___024unit___ctor_var_reset(Vtb_gen_int___024unit* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_gen_int__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_gen_int___024unit___ctor_var_reset\n"); );
    // Body
